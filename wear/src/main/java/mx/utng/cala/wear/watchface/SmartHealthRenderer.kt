package mx.utng.cala.wear.watchface
...
class SmartHealthRenderer(
    ...
    @Suppress("UNUSED_PARAMETER") complicationSlotsManager: ComplicationSlotsManager,
    ...
    override fun renderHighlightLayer(canvas: Canvas, bounds: Rect,
                                      zonedDateTime: ZonedDateTime, sharedAssets: Renderer.SharedAssets) {
